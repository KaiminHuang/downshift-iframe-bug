...
var containerFocusjail = require('@zendeskgarden/container-focusjail');
...
function useModal(_temp) {
  ...
  var _useState = React.useState(_id || seed("modal_" + '0.8.7')),
      idPrefix = _useState[0];
  var titleId = idPrefix + "--title";
  var contentId = idPrefix + "--content";
  var isModalMousedDownRef = React.useRef(false);
  ...
  var getBackdropProps = function getBackdropProps(_temp2) {
    var _ref2 = _temp2 === void 0 ? {} : _temp2,
        ...
        other = _objectWithoutPropertiesLoose(_ref2, ["onMouseUp"]);
    var containerId = 'containers.modal';
    return _extends({
      onMouseUp: containerUtilities.composeEventHandlers(onMouseUp, function (event) {
      ...
      'data-garden-container-version': '0.8.7'
    }, other);
  };
  var _getModalProps = function getModalProps(_temp3) {
    var _ref3 = _temp3 === void 0 ? {} : _temp3,
        ...
        other = _objectWithoutPropertiesLoose(_ref3, ["role", "onKeyDown", "onMouseDown"]);
    return _extends({
      role: role,
      tabIndex: -1,
      'aria-modal': true,
      ...
      onMouseDown: containerUtilities.composeEventHandlers(onMouseDown, function () {
        isModalMousedDownRef.current = true;
      }),
      onKeyDown: containerUtilities.composeEventHandlers(onKeyDown, function (event) {
        if (event.keyCode === containerUtilities.KEY_CODES.ESCAPE) {
          closeModal(event);
        }
      })
    }, other);
  ...
  var getContentProps = function getContentProps(_temp5) {
    var _ref5 = _temp5 === void 0 ? {} : _temp5,
        ...
        other = _objectWithoutPropertiesLoose(_ref5, ["id"]);
    return _extends({
      id: id
    }, other);
  };
  var getCloseProps = function getCloseProps(_temp6) {
    var _ref6 = _temp6 === void 0 ? {} : _temp6,
        ...
        other = _objectWithoutPropertiesLoose(_ref6, ["onClick"]);
    return _extends({
      'aria-label': 'Close modal',
      onClick: containerUtilities.composeEventHandlers(onClick, function (event) {
        closeModal(event);
      })
    }, other);
  };
  var _useFocusJail = containerFocusjail.useFocusJail({
...
var ModalContainer = function ModalContainer(_ref) {
  ...
  return React__default['default'].createElement(React__default['default'].Fragment, null, render(useModal(options)));
};
ModalContainer.propTypes = {
  children: PropTypes__default['default'].func,
  render: PropTypes__default['default'].func,
  onClose: PropTypes__default['default'].func,
  modalRef: PropTypes__default['default'].any.isRequired,
  id: PropTypes__default['default'].string,
  focusOnMount: PropTypes__default['default'].bool,
  restoreFocus: PropTypes__default['default'].bool,
  environment: PropTypes__default['default'].any
};
