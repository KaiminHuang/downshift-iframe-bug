...
var Dropdown = function Dropdown(props) {
  ...
  var customGetInputProps = function customGetInputProps(_ref, downshift, rtl) {
    ...
    return _objectSpread2({
      onKeyDown: containerUtilities.composeEventHandlers(onKeyDown, function (e) {
        ...
        } else if ((e.keyCode === containerUtilities.KEY_CODES.ENTER || e.keyCode === containerUtilities.KEY_CODES.SPACE) && !downshift.isOpen) {
          e.preventDefault();
          e.stopPropagation();
          downshift.openMenu();
        }
  ...
  return React__default['default'].createElement(reactPopper.Manager, null, React__default['default'].createElement(Downshift__default['default'], _extends({
    ...
    stateReducer: function stateReducer(_state, changes) {
      switch (changes.type) {
        case Downshift__default['default'].stateChangeTypes.controlledPropUpdatedSelectedItem:
        ...
        case Downshift__default['default'].stateChangeTypes.blurInput:
          return _objectSpread2(_objectSpread2({}, changes), {}, {
            inputValue: ''
          });
        case Downshift__default['default'].stateChangeTypes.keyDownEnter:
...
var getColorStyles = function getColorStyles(props) {
  return styled.css(["background-color:", ";color:", ";"], props.isFocused && !props.disabled && reactTheming.getColor('primaryHue', 600, props.theme, 0.08), props.disabled ? reactTheming.getColor('neutralHue', 400, props.theme) : props.theme.colors.foreground);
};
...
var StyledItemIcon = styled__default['default'].div(_templateObject$6(), function (props) {
...
var StyledNextIcon = styled__default['default'](NextIconComponent)(_templateObject$8(), function (props) {
...
var StyledPreviousIcon = styled__default['default'](PreviousIconComponent)(_templateObject$a(), function (props) {
  return props.theme.rtl && 'rotate(180deg)';
}, function (props) {
  return props.isDisabled ? 'inherit' : reactTheming.getColor('neutralHue', 600, props.theme);
}, function (props) {
...
var StyledFauxInput = styled__default['default'](reactForms.FauxInput).attrs({
...
var Autocomplete = React__default['default'].forwardRef(function (_ref, ref) {
  var children = _ref.children,
  ...
  var inputRef = containerUtilities.useCombinedRefs(controlledInputRef);
  var triggerRef = containerUtilities.useCombinedRefs(ref);
  ...
  return React__default['default'].createElement(reactPopper.Reference, null, function (_ref2) {
    var popperReference = _ref2.ref;
    return React__default['default'].createElement(StyledFauxInput, _extends({
...
var Multiselect = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  var _useFieldContext = useFieldContext(),
      isLabelHovered = _useFieldContext.isLabelHovered;
  var inputRef = containerUtilities.useCombinedRefs(externalInputRef);
  var triggerRef = containerUtilities.useCombinedRefs(popperReferenceElementRef, ref);
...
var Select = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  var _useState = React.useState(false),
      ...
      setIsHovered = _useState2[1];
  var hiddenInputRef = React.useRef(null);
  var triggerRef = containerUtilities.useCombinedRefs(ref, popperReferenceElementRef);
  var previousIsOpenRef = React.useRef(undefined);
...
var Field = function Field(props) {
  ...
  }, React__default['default'].createElement(reactForms.Field, _extends({
    ref: ref
  }, props)));
};

var Hint = React__default['default'].forwardRef(function (props, ref) {
  return React__default['default'].createElement(reactForms.Hint, _extends({
    ref: ref
  }, props));
});
...
var Label = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  return React__default['default'].createElement(reactForms.Label, _extends({
    ref: ref
  }, labelProps));
});
...
var Message = React__default['default'].forwardRef(function (props, ref) {
  return React__default['default'].createElement(reactForms.Message, _extends({
    ref: ref
  }, props));
});
...
var Menu = function Menu(props) {
  ...
  return React__default['default'].createElement(MenuContext.Provider, {
    ...
    return React__default['default'].createElement(StyledMenuWrapper, {
      ...
      zIndex: zIndex
    }, React__default['default'].createElement(StyledMenu, _extends({
      isCompact: isCompact,
      maxHeight: maxHeight,
      style: computedStyle
...
var Separator = React__default['default'].forwardRef(function (props, ref) {
  return React__default['default'].createElement(StyledSeparator, _extends({
    ref: ref
  }, props));
});
...
var Item = React__default['default'].forwardRef(function (_ref, forwardRef) {
  ...
  var itemRef = containerUtilities.useCombinedRefs(forwardRef);
...
var AddItemComponent = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  var _useMenuContext = useMenuContext(),
      isCompact = _useMenuContext.isCompact;
  return React__default['default'].createElement(StyledAddItem, _extends({
    ref: ref,
    disabled: disabled
...
var AddItem = React__default['default'].forwardRef(function (props, ref) {
  return React__default['default'].createElement(Item, _extends({
...
var HeaderIcon = React__default['default'].forwardRef(function (props, ref) {
  var _useMenuContext = useMenuContext(),
      isCompact = _useMenuContext.isCompact;
  return React__default['default'].createElement(StyledHeaderIcon, _extends({
    ref: ref,
    isCompact: isCompact
  }, props));
});
...
var ItemMeta = React__default['default'].forwardRef(function (props, ref) {
  ...
  return React__default['default'].createElement(StyledItemMeta, _extends({
    ref: ref,
    isCompact: isCompact,
...
var MediaBody = React__default['default'].forwardRef(function (props, ref) {
  var _useMenuContext = useMenuContext(),
      isCompact = _useMenuContext.isCompact;
  return React__default['default'].createElement(StyledMediaBody, _extends({
    ref: ref,
    isCompact: isCompact
  }, props));
});
...
var MediaFigure = function MediaFigure(props) {
  var _useMenuContext = useMenuContext(),
      isCompact = _useMenuContext.isCompact;
  return React__default['default'].createElement(StyledMediaFigure, _extends({
    isCompact: isCompact
  }, props));
};
...
var NextItemComponent = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  var _useMenuContext = useMenuContext(),
      isCompact = _useMenuContext.isCompact;
  return React__default['default'].createElement(StyledNextItem, _extends({
    ref: ref,
    disabled: disabled
  }, props), React__default['default'].createElement(StyledItemIcon, {
    isCompact: isCompact,
...
var PreviousItemComponent = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  var _useMenuContext = useMenuContext(),
      isCompact = _useMenuContext.isCompact;
  return React__default['default'].createElement(StyledPreviousItem, _extends({
    ref: ref,
    disabled: disabled
  }, props), React__default['default'].createElement(StyledItemIcon, {
    isCompact: isCompact,
