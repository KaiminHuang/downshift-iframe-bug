 ...
 */
export declare const StyledMediaFigure: import("styled-components").StyledComponent<({ children, isCompact, theme, ...props }: React.PropsWithChildren<IStyledMediaFigureProps & ThemeProps<DefaultTheme>>) => React.DetailedReactHTMLElement<{
