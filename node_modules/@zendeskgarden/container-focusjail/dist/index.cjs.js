...
var useFocusJail = function useFocusJail(_temp) {
  ...
  var getContainerProps = function getContainerProps(_temp2) {
    var _ref2 = _temp2 === void 0 ? {} : _temp2,
        ...
        other = _objectWithoutPropertiesLoose(_ref2, ["onKeyDown"]);
    return _extends({
      onKeyDown: containerUtilities.composeEventHandlers(onKeyDown, function (event) {
        if (event.keyCode !== containerUtilities.KEY_CODES.TAB) {
          return;
        }
      ...
      'data-garden-container-version': '1.4.6'
    }, other);
  };
  React.useEffect(function () {
...
FocusJailContainer.propTypes = {
  ...
  focusElem: PropTypes__default['default'].func
};
