...
interface IStaticDrawerModalExport<T, P> extends ForwardRefExoticComponent<PropsWithoutRef<P> & RefAttributes<T>> {
 ...
 */
export declare const DrawerModal: IStaticDrawerModalExport<HTMLDivElement, IDrawerModalProps>;
export {};
