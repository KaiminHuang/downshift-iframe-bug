...
var animationName = styled.keyframes(["0%{opacity:0;}100%{opacity:1;}"]);
var StyledBackdrop = styled__default['default'].div.attrs({
  ...
  return props.isAnimated && styled.css(["", " 0.15s ease-in"], animationName);
}, function (props) {
...
var StyledDangerIcon = styled__default['default'](SvgAlertErrorStroke)(_templateObject$6(), function (props) {
...
var animationName$1 = styled.keyframes(["0%{transform:scale(0);opacity:0;}50%{transform:scale(1.05);}100%{opacity:1;}"]);
...
var StyledModal = styled__default['default'].div.attrs({
  ...
  return props.isAnimated && styled.css(["", " 0.3s ease-in-out"], animationName$1);
}, function (props) {
  return props.theme.rtl && 'rtl';
...
var Body = React__default['default'].forwardRef(function (props, ref) {
  ...
  return React__default['default'].createElement(StyledBody, _extends({
    ref: ref
...
var Title = React__default['default'].forwardRef(function (props, ref) {
  ...
  return React__default['default'].createElement(StyledTooltipModalTitle, _extends({
    ref: ref
...
var Body$1 = React__default['default'].forwardRef(function (props, ref) {
  ...
  return React__default['default'].createElement(StyledTooltipModalBody, _extends({
    ref: ref
  }, getContentProps(props)));
});
...
var Close$1 = React__default['default'].forwardRef(function (props, ref) {
  ...
  return React__default['default'].createElement(StyledTooltipModalClose, _extends({
    ref: ref
  }, getCloseProps(props)), React__default['default'].createElement(SvgXStroke, null));
});
...
var TooltipModal = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  var modalRef = containerUtilities.useCombinedRefs(ref);
  ...
  return referenceElement ? React__default['default'].createElement(TooltipModalContext.Provider, {
    value: value
  }, React__default['default'].createElement(StyledTooltipModalBackdrop, getBackdropProps(backdropProps), React__default['default'].createElement(StyledTooltipWrapper, _extends({
    ref: setPopperElement,
    style: styles.popper,
    placement: state ? state.placement : undefined,
    zIndex: zIndex,
    isAnimated: isAnimated
  }, attributes.popper), React__default['default'].createElement(StyledTooltipModal, modalProps)))) : null;
});
...
var Header$1 = React__default['default'].forwardRef(function (props, ref) {
  var _useModalContext = useModalContext(),
      getTitleProps = _useModalContext.getTitleProps;
  return React__default['default'].createElement(StyledDrawerModalHeader, _extends({
    ref: ref
  }, getTitleProps(props)));
});
...
var Body$2 = React__default['default'].forwardRef(function (props, ref) {
  var _useModalContext = useModalContext(),
      getContentProps = _useModalContext.getContentProps;
  return React__default['default'].createElement(StyledDrawerModalBody, _extends({
    ref: ref
...
var Close$2 = React__default['default'].forwardRef(function (props, ref) {
  var _useModalContext = useModalContext(),
      getCloseProps = _useModalContext.getCloseProps;
  return React__default['default'].createElement(StyledDrawerModalClose, _extends({
    ref: ref
  }, getCloseProps(props)), React__default['default'].createElement(SvgXStroke, null));
});
...
var DrawerModal = React.forwardRef(function (_ref, ref) {
  ...
  }, React__default['default'].createElement(StyledDrawerModal, modalProps)), isOpen && React__default['default'].createElement(StyledBackdrop, getBackdropProps(_objectSpread2({
    isAnimated: true
